...
echo "Calling Claim function to get 0.01 OKB..."
cast send $NATIVE_ISSUE_ADDRESS "Claim(uint256)" 10000000000000000 --private-key $EOA_PRIVATE_KEY --rpc-url $L2_RPC --legacy
