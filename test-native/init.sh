...
cd "$ROOT_DIR"
ROLLUP_OUTPUT_PATH=$(find ./test-native/agglayer-contracts/deployment/v2 -name "create_rollup_output_*.json" | sort -r | head -n 1)
rm -rf ./test-native/contract/*
cp -rf $ROLLUP_OUTPUT_PATH ./test-native/contract/create_rollup_output.json
cp -rf ./test-native/agglayer-contracts/deployment/v2/create_rollup_parameters.json ./test-native/contract/
cp -rf ./test-native/agglayer-contracts/deployment/v2/deploy_parameters.json ./test-native/contract/
cp -rf ./test-native/agglayer-contracts/deployment/v2/deploy_output.json ./test-native/contract/
cp -rf ./test-native/agglayer-contracts/deployment/v2/genesis.json ./test-native/contract/
ROLLUP_OUTPUT_PATH="./test-native/contract/create_rollup_output.json"
DEPLOY_OUTPUT_PATH="./test-native/contract/deploy_output.json"
...
which allocs
allocs ./test-native/agglayer-contracts/deployment/v2/genesis.json
mv allocs.json ./test-native/config/dynamic-mynetwork-allocs.json

cat > ./test-native/config/dynamic-mynetwork-conf.json << EOF
{
  "root": "$GENESIS_VALUE",
...
CONFIG_FILE="./test-native/config/test.erigon.seq.config.yaml"
...
CONFIG_FILE="./test-native/config/cdk-node-config.toml"
...
GENESIS_CONFIG_FILE="./test-native/config/test.genesis.config.json"
