...
func (c *Client) newClientConn(conn ServerCodec) *clientConn {
	...
	handler := newHandler(ctx, conn, c.idgen, c.services, c.methodAllowList, 50, false /* traceRequests */, c.logger, 0, c.apiKey)
...
func initClient(conn ServerCodec, idgen func() ID, services *serviceRegistry, logger log.Logger, apikey string) *Client {
