...
func main() {
	...
	cmd.RunE = func(cmd *cobra.Command, args []string) error {
		...
		apiList, _ := jsonrpc.APIList(db, dbsmt, backend, txPool, nil, mining, ff, stateCache, blockReader, agg, cfg, engine, &ethConfig, nil, logger, nil, gasTracker, nil, false, nil, nil, nil)
